...
export const pixel = 'https://devnet-extras-api.multiversx.com/xday/tickets/c'; // TODO: This must be set
...
export const extrasApi = 'https://devnet-extras-api.multiversx.com';
